...
export default function App() {
  ...
  const s = {
    ...
    chatWindow: { width: '100%', maxWidth: '760px', flex: 1, overflowY: 'auto', padding: '1.2rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem', minHeight: '0', height: 'calc(100vh - 180px)' },
    ...
    inputRow: { width: '100%', maxWidth: '760px', padding: '0.8rem 1rem 1.5rem', display: 'flex', gap: '6px', borderTop: `1px solid ${colors.border}`, background: colors.bg, position: 'sticky', bottom: 0, boxSizing: 'border-box' },
    input: { flex: 1, background: colors.surface, border: `1px solid ${colors.border}`, borderRadius: '12px', padding: '0.7rem 1rem', color: colors.text, fontSize: '0.9rem', outline: 'none', fontFamily: "'DM Sans', sans-serif", resize: 'none', lineHeight: '1.5', minWidth: '0' },
    ...
    surpriseBtn: { background: 'transparent', border: `1px solid ${colors.border}`, borderRadius: '12px', padding: '0 0.6rem', fontSize: '0.75rem', cursor: 'pointer', color: colors.text, fontFamily: "'DM Sans', sans-serif", flexShrink: 0, whiteSpace: 'nowrap' },
